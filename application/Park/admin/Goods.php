...
class Goods extends Admin {
    ...
    public function add() {
        if (request()->isPost()) {
            ...
            $builder->setMetaTitle("新增")  // 设置页面标题
                    ...
                    ->addFormItem('price', 'price', '商品价格', '商品价格')
                    ->addFormItem('old_price', 'price', '商品原价', '商品原价')
                    ->addFormItem('total', 'num', '商品库存', '商品原价')
                    ->addFormItem('file', 'file', '商品库存', '商品原价')
                          
                    ->addFormItem('box_price', 'price', '餐盒价格', '餐盒价格')
    ...
    public function edit($id) {
        if (request()->isPost()) {
            $data = D("food_goods")->editfood(true);
            if ($data) {
                $this->success("新增成功", U("index"));
            } else {
                $this->error("新增失败".$model_object->getError());
