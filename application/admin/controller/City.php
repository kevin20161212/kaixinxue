...
class City extends Admin {
    ...
    public function index() {
        ...
        $attr['href']  = U('City/del', array('id' => '__data_id__','model'=>'Home_District'));
        ...
        $builder->setMetaTitle("列表")  // 设置页面标题
                ...
                ->addRightButton("forbid",array('model'=>'Home_City'))  // 添加禁用/启用按钮
