...
class Index extends Admin {
    ...
    public function index() {
        ...
        $builder->setMetaTitle("列表")  // 设置页面标题
                ...
                ->addTopButton("resume",array('model'=>'book_index'))  // 添加启用按钮
                ->addTopButton("forbid",array('model'=>'book_index'))  // 添加禁用按钮
                ->addTopButton("delete",array('model'=>'book_index'))  // 添加禁用按钮
                ...
                ->addRightButton("forbid",array('model'=>'book_index'))  // 添加禁用/启用按钮
                ->addRightButton("delete",array('model'=>'book_index'))  // 添加删除按钮
                ->display();
    }
        ...
        if (request()->isPost()) {
           $data = D("book_index")->edits(true);
            ...
            $builder->setMetaTitle("编辑")  // 设置页面标题
                    ...
                    ->setFormData(D("book_index")->find($id))
                    ->display();
        }
    }
}