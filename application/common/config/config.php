...
$_config = [
    ...
    'view_replace_str'       => array(
        ...
        '__MOBILE_IMG__' => \think\Request::instance()->domain() . __ROOT__ . ltrim(APP_DIR, '.') .'home/static/mobile/img',
        '__MOBILE_CSS__' => \think\Request::instance()->domain() . __ROOT__ . ltrim(APP_DIR, '.') .'home/static/mobile/css',
        '__MOBILE_JS__'  => \think\Request::instance()->domain() . __ROOT__ . ltrim(APP_DIR, '.') .'home/static/mobile/js',
        '__MOBILE_IMG1__' => \think\Request::instance()->domain() . __ROOT__ . ltrim(APP_DIR, '.') .'home/static/mobile1/img',
        '__MOBILE_CSS1__' => \think\Request::instance()->domain() . __ROOT__ . ltrim(APP_DIR, '.') .'home/static/mobile1/css',
        '__MOBILE_JS1__'  => \think\Request::instance()->domain() . __ROOT__ . ltrim(APP_DIR, '.') .'home/static/mobile1/js',
        '__MOBILE_DIST__'  => \think\Request::instance()->domain() . __ROOT__ . ltrim(APP_DIR, '.') .'home/static/mobile/dist',
        '__MOBILE_VIDEO__' => \think\Request::instance()->domain() . __ROOT__ . ltrim(APP_DIR, '.') .'home/static/mobile/video',
        '__MOBILE_FONT__'=> \think\Request::instance()->domain() . __ROOT__ . ltrim(APP_DIR, '.') .'home/static/mobile/font',
    ),
    // 默认跳转页面对应的模板文件
    ...
    //微信配置
    'wxpay'  => [
        'appid' => 'wxa624d75189425041',
        'mchid' => '1315604501',
        'key' => 'c704f70362a3be2b306cd5219b7096cd',
        'appsecret' => '77f31d8ef661e2e9ef73b0585f7b0522',
    ],
];
