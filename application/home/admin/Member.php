...
class Member extends Admin {
    ...
    public function index() {
        ...
        $map['id|contact_name|mobile'] = array($condition);
       ...
       foreach ($data_list as $key => &$value) {
        ...
        $builder->setMetaTitle('用户列表') // 设置页面标题
            ...
            ->addTopButton('resume',array('model'=>'Home_Member')) // 添加启用按钮
            ->addTopButton('forbid',array('model'=>'Home_Member')) // 添加禁用按钮
            ->addTopButton('delete',array('model'=>'Home_Member')) // 添加删除按钮
