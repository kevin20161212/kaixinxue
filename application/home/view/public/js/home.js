$(function(){
    ...
    $('img.lazy').lazyload({
        effect         : 'fadeIn',
        data_attribute : 'src',
        placeholder    : window.yfthink.default_img
    });
    ...
    $(document).on('click', '.send-mail-verify', function() {
        var url = window.yfthink.top_home_page + '/index.php?s=/user/user/send_mail_verify';
        var that = this;
    ...
    $(document).on('click', '.send-mobile-verify', function() {
        var url = window.yfthink.top_home_page + '/index.php?s=/user/user/send_mobile_verify';
        var that = this;
        var title = $(that).attr('data-title');
    ...
    function get_location_success(position){
        ...
        $.cookie('oc_latitude', lat, {path: window.yfthink.var_root});
        $.cookie('oc_longitude', lng, {path: window.yfthink.var_root});
    }
