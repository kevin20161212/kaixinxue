...
class Ceshi extends Controller
{
    ...
    public function index(){
		...
		$configs = array(
			...
			'scan_urls' => array(
				'http://www.sdbidding.org.cn/info_class.asp?classid=173'
			),
			'list_url_regexes' => array(
				
			),
			'content_url_regexes' => array(
				"http://www.sdzfcg.gov.cn/site/Page/Information/AfficheInfo.aspx\?id=[\w]+\&projectcode=[\w]+",
			),
			'max_try' => 5,
			...
			'fields' => array(
				array(
					'name' => "article_title",
					'selector' => "//td[contains(@class,'font1')]",
					'required' => true,
				),							
				array(
					'name' => "article_content",
					'selector' => "//td[contains(@class,'font2')]",
					'required' => true,
				),
				array(
