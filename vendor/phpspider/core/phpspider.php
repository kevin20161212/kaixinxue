...
class phpspider
{
    ...
    * ) 
    ...
    {
        // dump($url);
		// dump(self::$configs['content_url_regexes']);
		 // echo '------------';
		$result = false;        
    ...
    public function collect_page() 
    {
		...
		if ($link['url_type'] == 'scan_page') 
        {
            ...
            {                 
                ...
                if (isset($return)) $is_find_url = $this;
            }
        }
        elseif ($link['url_type'] == 'list_page') 
        {
    ...
    public function link_uncompress($link)
    {
        $link = array(
			...
			'ceshi'        => isset($link['ceshi'])        ? $link['ceshi']        : self::$configs['ceshi'], 
			'bas_url'        => isset($link['bas_url'])        ? $link['bas_url']        : self::$configs['bas_url'],			
        );
    ...
    public function get_html_fields($html, $url, $page) 
    {
        ...
        if (!empty($fields)) 
        {
            ...
            {
                $return = call_user_func($this->on_extract_page, $page, $fields,self::$configs['ext']);
                if (!isset($return))
                {
